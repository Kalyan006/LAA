					...
					if (Execute == true || "BAT".equals(GlobalVar.TestType)) {
							try {
								...
								aapo.EnterAddAccAccountName(AccountName);
									...
									// account type
									String AddAccAccountType = GenericUtils.cellValue(sheet, rownum, 1).trim();
									logger.info(AddAccAccountType);
									if(AddAccAccountType!=null || !AddAccAccountType.equals("")){
									...
									// Add account page Account Information,select
									// account category
									String AddAccAccountCategory = GenericUtils.cellValue(sheet, rownum, 2).trim();
									logger.info(AddAccAccountCategory);
									if(AddAccAccountCategory!=null || !AddAccAccountCategory.equals("")){
									...
									if(AddAccSsn!=null || !AddAccSsn.equals("")){
									...
									if(StateAssignedId!=null || !StateAssignedId.equals("")){
										//Thread.sleep(GlobalVar.threadSleep);
									...
									if(TaxonomyCodeSet!=null || !TaxonomyCodeSet.equals("")){
										Thread.sleep(GlobalVar.threadSleep);
									...
									logger.info(TaxonomyCode);
									if(TaxonomyCode!=null || !TaxonomyCode.equals("")){
										Thread.sleep(GlobalVar.threadSleep);
									...
									if(ACIState!=null || !ACIState.equals("")){
									...
									if(OperatorUserID!=null || !OperatorUserID.equals("")){
									...
									if(RegistrationKey!=null || !RegistrationKey.equals("")){
									...
									if(POSProgramID!=null || !POSProgramID.equals("")){
									...
									if(LaneID!=null || !LaneID.equals("")){
										...
										TC_16_Add_Account.log(LogStatus.INFO,
											"Account Name : " + AccountName + " || Account Type : " + AddAccAccountType + "|| Account Category : " + AddAccAccountCategory );
									}
