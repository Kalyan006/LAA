package com.phm.hec.BM.Objects;
...
public class BMPageObject {
	...
	@FindBy(xpath = ".//*[@id='divAttrResults']/div[2]/table/tbody/tr[2]/td[13]")
	public WebElement ProviderNPI;

	public String StoreProviderNPI() {
		String NPItxt = ProviderNPI.getText();
		return NPItxt;
		
	}
	
	@FindBy(xpath = ".//*[@id='divAttrResults']/div[2]/table/tbody/tr[2]/td[15]")
	public WebElement ProviderTIN;

	public String StoreProviderTIN() {
		String TINtxt = ProviderTIN.getText();
		return TINtxt;
