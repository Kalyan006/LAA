...
public class AddProviderPageObjects
{
	...
	//Add Provider page Provider Identification Organization Assigned ID text field.
	...
	//Add Provider page Provider Other Information Prefered communication ddl field.
	...
	//Add Provider page Provider Other Information Hospital affiliation1 text field.
	...
	//Add Provider page Provider Other Information Hospital affiliation2 text field.
	...
	//Add Provider page Provider Other Information Hospital affiliation3 text field.
	...
	//Add Provider page Provider Other Information Hospital affiliation4 text field.
	...
	//Add Provider page Credit / Debit Payment Gateway Operator/user id text field.
	...
	//Add Provider page Credit / Debit Payment Gateway Registration Key text field.
	...
	//Add provider page select assign region then delete button
	...
	/*public void GetRegionRowNo(String tablename,String regioncode,int recordstartrow)
	{	
		//Grab the table
		WebElement table=GlobalVar.Driver.findElement(By.id(tablename));
		//Now get all the tr elements from the table
		List<WebElement> allrows=table.findElements(By.tagName(regioncode));
		//And iterate over them,getting the cells
		for(WebElement row: allrows)
		{
			String td = null;
			List<WebElement> cells=row.findElements(By.tagName(td));
			//Print the contents of all cell
	...
	public void ClickDdlTransactionType(int index)
	{
		GenericUtils.selectDdlByIndex(DdlTransactionType, index);
	}
