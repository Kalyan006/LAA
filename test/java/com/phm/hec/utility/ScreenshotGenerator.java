	...
	public  static void copyfile(File Scr, File Dst) throws IOException
	{
		if(Scr.isDirectory())
		{
			...
			public static void ScreenShot_AddToXSLT(String TestNameAndTcid, String Reason_for_fail) throws IOException
			{
				...
				String Dstfilepath=System.getProperty("user.dir")+"\\OldScreenShots\\PreviousScreenshots "+dateFormat.format(dat);
				...
				File srcFile=((TakesScreenshot)GlobalVar.Driver).getScreenshotAs(OutputType.FILE);				
			      try {
			        FileUtils.copyFile(srcFile, new File(System.getProperty("user.dir")+"/Screenshot/"+ TestName+"_"+Pass_or_Fail+"_"+TestID+ ".jpg"));
			         if (Pass_or_Fail.equals("Pass"))
			         {
			        Reporter.log("<tr><td><a href='"+"file:///"+ System.getProperty("user.dir")+"/Screenshot/"+ TestName+"_"+Pass_or_Fail+"_"+TestID+ ".jpg'> <img src='"+"file:///"+ System.getProperty("user.dir")+"/Screenshot/"+  TestName+"_"+Pass_or_Fail+"_"+TestID+ ".jpg' height='100' width='100'/>"
			        +"<b><strong><font size='"+"3"+"' color='"+"OrangeRed"+"'></font></strong></b>"+"<b><font size='"+"3"+"' color='"+"Indigo"+"'>"+TestName+"_"+"<font size='"+"3"+"' color='"+"green"+"'>"+Pass_or_Fail+"</font>"+"_"+TestID+"</font></b></a></td></tr>");
			         }  else if (!Pass_or_Fail.equals("Fail") && !Pass_or_Fail.equals("Pass"))
			         {
			        Reporter.log("<tr><td><a href='"+"file:///"+ System.getProperty("user.dir")+"/Screenshot/"+ TestName+"_"+Pass_or_Fail+"_"+TestID+ ".jpg'> <img src='"+"file:///"+ System.getProperty("user.dir")+"/Screenshot/"+  TestName+"_"+Pass_or_Fail+"_"+TestID+ ".jpg' height='100' width='100'/>"
			        		        +"<b><strong><font size='"+"3"+"' color='"+"Orange"+"'></font></strong></b>"
			        			 +"<b><font size='"+"3"+"' color='"+"Indigo"+"'>"+TestName+"_"+"<font size='"+"3"+"' color='"+"Orange"+"'>"+Pass_or_Fail+"</font>"+"_"+TestID+"</font></b></a></td></tr>");
			         }
			         
			         else
			         {
			        Reporter.log("<tr><td><a href='"+"file:///"+ System.getProperty("user.dir")+"/Screenshot/"+ TestName+"_"+Pass_or_Fail+"_"+TestID+ ".jpg'> <img src='"+"file:///"+ System.getProperty("user.dir")+"/Screenshot/"+  TestName+"_"+Pass_or_Fail+"_"+TestID+ ".jpg' height='100' width='100'/>"
			        		        +"<b><strong><font size='"+"3"+"' color='"+"OrangeRed"+"'></font></strong></b>"
			        			 +"<b><font size='"+"3"+"' color='"+"Indigo"+"'>"+TestName+"_"+"<font size='"+"3"+"' color='"+"red"+"'>"+Pass_or_Fail+"</font>"+"_"+TestID+"</font></b></a></td></tr>");
			        	 Reporter.log("<font size='"+"3"+"' color='"+"Tomato"+"'>Reason for Failuer   :  </font>" +"<font size='"+"3"+"' color='"+"DarkSlateGray"+"'>"+Reason_for_fail+"</font>");
			         }
			    } catch (IOException e) 
